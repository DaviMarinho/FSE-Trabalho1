...
// #include "menu.h"
  ...
  while (1) {
    ...
    printf("TRATA SENSORESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS1\n");
    trataSensores(command);
    printf("TRATA SENSORESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS123123\n");
